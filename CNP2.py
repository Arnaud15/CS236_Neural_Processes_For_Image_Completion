...
class ContextEncoder(nn.Module):
    ...
    def z_params_from_r(self, r):
        return self.mu_layer(r), self.logvar_layer(r)
...
def train_new(context_encoder, target_network, train_loader, optimizer, n_epochs, device, batch_size):
    r_full = ...
    r_masked = ...
