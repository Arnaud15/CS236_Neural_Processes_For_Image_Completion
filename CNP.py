...
def train(context_encoder, target_network, train_loader, optimizer, n_epochs, device, batch_size):
      ...
      for epoch in range(n_epochs):
            ...
            for batch_idx, (batch, _) in enumerate(train_loader):
                  if(batch_idx % 100) == 0:
                        print("Batch " + str(batch_idx) + "... Current accumulated loss: " + str(accumulated_loss))
                  ...
                  aggregated_context_embedding = aggregated_context_embedding.view(batch_size, 1, -1)
                  aggregated_context_embedding = torch.cat([aggregated_context_embedding]*784, dim=1)
                  ...
                  loss.backward()
                  optimizer.step()
            print("Accumulated loss:" + str(accumulated_loss))
            print
      return
